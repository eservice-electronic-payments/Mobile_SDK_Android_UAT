...
//            "-----END CERTIFICATE-----"
    ...
    fun initialize(context: Context, initParams: ThreeDS2ChallengeRequestParams): Transaction {
        try {
            val licenseKey = initParams.licenseKeyReversed.reversed()//"5453473256444E585246323032313038313338444D44323832320000000000000000000000000000303030303030303000004543384A575256474D3855480000"
...
//                "#951728" // Dark red
            ...
            return ThreeDS2Service.INSTANCE.createTransaction(initParams.directoryServerId, initParams.messageVersion)
        } catch (ex: Exception) {
